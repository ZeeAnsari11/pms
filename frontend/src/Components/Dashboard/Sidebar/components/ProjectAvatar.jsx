...
const propTypes = {
    ...
    iconImage: PropTypes.string, // New prop for the icon image
};

const defaultProps = {
    className: undefined,
    size: 40,
    iconImage: null, // Default value for the icon image prop
};

const ProjectAvatar = ({className, size, iconImage}) => (
    <span className={className}>
    {iconImage ? ( // Check if iconImage prop is passed
        <img
            src={iconImage}
            alt="Icon Image"
            width={size}
